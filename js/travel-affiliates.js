...
window.TRAVEL_AFFILIATES = {
  ...
  /** Motor de búsqueda oficial (Rentcars Affiliates → Widgets v13). Al buscar, envía postMessage → resultados en iframe en la misma página. */
  rentcarsWidgetSrc:
    'https://widgets.rentcars.com/widget-v13.html?requestor=10695&locale=es&utm_source=web-lerma.vercel.app&utm_medium=afiliado-widget',
